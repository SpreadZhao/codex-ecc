# ECC Command Prompt: /test-coverage

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/test-coverage.md

Use this prompt to run the ECC `test-coverage` workflow in Codex.
