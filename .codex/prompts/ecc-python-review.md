# ECC Command Prompt: /python-review

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/python-review.md

Use this prompt to run the ECC `python-review` workflow in Codex.
