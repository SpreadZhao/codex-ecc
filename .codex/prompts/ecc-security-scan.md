# ECC Command Prompt: /security-scan

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/security-scan.md

Use this prompt to run the ECC `security-scan` workflow in Codex.
