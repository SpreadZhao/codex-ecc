# ECC Command Prompt: /cpp-review

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/cpp-review.md

Use this prompt to run the ECC `cpp-review` workflow in Codex.
