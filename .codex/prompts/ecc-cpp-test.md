# ECC Command Prompt: /cpp-test

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/cpp-test.md

Use this prompt to run the ECC `cpp-test` workflow in Codex.
