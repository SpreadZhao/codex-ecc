# ECC Command Prompt: /hookify

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/hookify.md

Use this prompt to run the ECC `hookify` workflow in Codex.
