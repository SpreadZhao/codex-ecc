# ECC Command Prompt: /kotlin-review

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/kotlin-review.md

Use this prompt to run the ECC `kotlin-review` workflow in Codex.
