# ECC Command Prompt: /marketing-campaign

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/marketing-campaign.md

Use this prompt to run the ECC `marketing-campaign` workflow in Codex.
