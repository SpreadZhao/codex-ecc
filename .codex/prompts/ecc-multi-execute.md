# ECC Command Prompt: /multi-execute

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/multi-execute.md

Use this prompt to run the ECC `multi-execute` workflow in Codex.
