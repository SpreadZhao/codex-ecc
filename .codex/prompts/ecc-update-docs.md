# ECC Command Prompt: /update-docs

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/update-docs.md

Use this prompt to run the ECC `update-docs` workflow in Codex.
