# ECC Command Prompt: /hookify-configure

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/hookify-configure.md

Use this prompt to run the ECC `hookify-configure` workflow in Codex.
