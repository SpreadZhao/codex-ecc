# ECC Command Prompt: /multi-plan

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/multi-plan.md

Use this prompt to run the ECC `multi-plan` workflow in Codex.
