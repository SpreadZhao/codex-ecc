# ECC Command Prompt: /skill-health

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/skill-health.md

Use this prompt to run the ECC `skill-health` workflow in Codex.
