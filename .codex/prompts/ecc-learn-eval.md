# ECC Command Prompt: /learn-eval

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/learn-eval.md

Use this prompt to run the ECC `learn-eval` workflow in Codex.
