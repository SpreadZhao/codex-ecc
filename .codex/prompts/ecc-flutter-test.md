# ECC Command Prompt: /flutter-test

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/flutter-test.md

Use this prompt to run the ECC `flutter-test` workflow in Codex.
