# ECC Command Prompt: /multi-backend

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/multi-backend.md

Use this prompt to run the ECC `multi-backend` workflow in Codex.
