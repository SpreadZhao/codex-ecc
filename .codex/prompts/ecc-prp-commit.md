# ECC Command Prompt: /prp-commit

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/prp-commit.md

Use this prompt to run the ECC `prp-commit` workflow in Codex.
