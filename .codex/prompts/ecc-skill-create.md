# ECC Command Prompt: /skill-create

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/skill-create.md

Use this prompt to run the ECC `skill-create` workflow in Codex.
