# ECC Command Prompt: /instinct-export

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/instinct-export.md

Use this prompt to run the ECC `instinct-export` workflow in Codex.
