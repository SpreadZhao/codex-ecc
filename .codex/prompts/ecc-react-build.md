# ECC Command Prompt: /react-build

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/react-build.md

Use this prompt to run the ECC `react-build` workflow in Codex.
