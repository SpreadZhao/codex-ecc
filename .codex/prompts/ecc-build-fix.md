# ECC Command Prompt: /build-fix

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/build-fix.md

Use this prompt to run the ECC `build-fix` workflow in Codex.
