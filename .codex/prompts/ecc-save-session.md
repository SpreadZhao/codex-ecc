# ECC Command Prompt: /save-session

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/save-session.md

Use this prompt to run the ECC `save-session` workflow in Codex.
