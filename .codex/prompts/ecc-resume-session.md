# ECC Command Prompt: /resume-session

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/resume-session.md

Use this prompt to run the ECC `resume-session` workflow in Codex.
