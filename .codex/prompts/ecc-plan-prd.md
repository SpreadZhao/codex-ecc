# ECC Command Prompt: /plan-prd

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/plan-prd.md

Use this prompt to run the ECC `plan-prd` workflow in Codex.
