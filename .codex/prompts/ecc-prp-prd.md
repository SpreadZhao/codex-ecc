# ECC Command Prompt: /prp-prd

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/prp-prd.md

Use this prompt to run the ECC `prp-prd` workflow in Codex.
