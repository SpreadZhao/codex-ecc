# ECC Command Prompt: /rust-test

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/rust-test.md

Use this prompt to run the ECC `rust-test` workflow in Codex.
