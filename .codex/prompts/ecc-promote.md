# ECC Command Prompt: /promote

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/promote.md

Use this prompt to run the ECC `promote` workflow in Codex.
