# ECC Command Prompt: /multi-workflow

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/multi-workflow.md

Use this prompt to run the ECC `multi-workflow` workflow in Codex.
