# ECC Command Prompt: /instinct-status

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/instinct-status.md

Use this prompt to run the ECC `instinct-status` workflow in Codex.
