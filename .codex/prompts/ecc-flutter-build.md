# ECC Command Prompt: /flutter-build

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/flutter-build.md

Use this prompt to run the ECC `flutter-build` workflow in Codex.
