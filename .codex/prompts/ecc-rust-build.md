# ECC Command Prompt: /rust-build

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/rust-build.md

Use this prompt to run the ECC `rust-build` workflow in Codex.
