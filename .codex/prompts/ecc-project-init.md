# ECC Command Prompt: /project-init

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/project-init.md

Use this prompt to run the ECC `project-init` workflow in Codex.
