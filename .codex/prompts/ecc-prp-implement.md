# ECC Command Prompt: /prp-implement

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/prp-implement.md

Use this prompt to run the ECC `prp-implement` workflow in Codex.
