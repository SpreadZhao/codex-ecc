# ECC Command Prompt: /hookify-help

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/hookify-help.md

Use this prompt to run the ECC `hookify-help` workflow in Codex.
