# ECC Command Prompt: /aside

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/aside.md

Use this prompt to run the ECC `aside` workflow in Codex.
