# ECC Command Prompt: /prp-plan

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/prp-plan.md

Use this prompt to run the ECC `prp-plan` workflow in Codex.
