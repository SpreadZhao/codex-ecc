# ECC Command Prompt: /go-review

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/go-review.md

Use this prompt to run the ECC `go-review` workflow in Codex.
