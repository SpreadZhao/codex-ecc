# ECC Command Prompt: /ecc-guide

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/ecc-guide.md

Use this prompt to run the ECC `ecc-guide` workflow in Codex.
