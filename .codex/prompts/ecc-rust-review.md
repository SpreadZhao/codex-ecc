# ECC Command Prompt: /rust-review

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/rust-review.md

Use this prompt to run the ECC `rust-review` workflow in Codex.
