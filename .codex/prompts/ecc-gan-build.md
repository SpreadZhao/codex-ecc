# ECC Command Prompt: /gan-build

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/gan-build.md

Use this prompt to run the ECC `gan-build` workflow in Codex.
