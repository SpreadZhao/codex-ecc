# ECC Command Prompt: /refactor-clean

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/refactor-clean.md

Use this prompt to run the ECC `refactor-clean` workflow in Codex.
