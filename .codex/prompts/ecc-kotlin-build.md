# ECC Command Prompt: /kotlin-build

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/kotlin-build.md

Use this prompt to run the ECC `kotlin-build` workflow in Codex.
