# ECC Command Prompt: /gradle-build

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/gradle-build.md

Use this prompt to run the ECC `gradle-build` workflow in Codex.
