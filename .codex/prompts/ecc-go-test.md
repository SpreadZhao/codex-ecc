# ECC Command Prompt: /go-test

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/go-test.md

Use this prompt to run the ECC `go-test` workflow in Codex.
