# ECC Command Prompt: /sessions

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/sessions.md

Use this prompt to run the ECC `sessions` workflow in Codex.
