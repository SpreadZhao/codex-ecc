# ECC Command Prompt: /flutter-review

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/flutter-review.md

Use this prompt to run the ECC `flutter-review` workflow in Codex.
