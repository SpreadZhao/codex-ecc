# ECC Command Prompt: /react-test

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/react-test.md

Use this prompt to run the ECC `react-test` workflow in Codex.
