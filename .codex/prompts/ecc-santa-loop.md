# ECC Command Prompt: /santa-loop

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/santa-loop.md

Use this prompt to run the ECC `santa-loop` workflow in Codex.
