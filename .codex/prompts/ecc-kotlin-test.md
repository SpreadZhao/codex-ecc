# ECC Command Prompt: /kotlin-test

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/kotlin-test.md

Use this prompt to run the ECC `kotlin-test` workflow in Codex.
