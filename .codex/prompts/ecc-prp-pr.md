# ECC Command Prompt: /prp-pr

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/prp-pr.md

Use this prompt to run the ECC `prp-pr` workflow in Codex.
