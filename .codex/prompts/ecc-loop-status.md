# ECC Command Prompt: /loop-status

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/loop-status.md

Use this prompt to run the ECC `loop-status` workflow in Codex.
