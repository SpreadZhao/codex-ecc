# ECC Command Prompt: /update-codemaps

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/update-codemaps.md

Use this prompt to run the ECC `update-codemaps` workflow in Codex.
