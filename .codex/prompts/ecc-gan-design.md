# ECC Command Prompt: /gan-design

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/gan-design.md

Use this prompt to run the ECC `gan-design` workflow in Codex.
