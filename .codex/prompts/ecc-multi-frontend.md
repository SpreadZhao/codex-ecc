# ECC Command Prompt: /multi-frontend

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/multi-frontend.md

Use this prompt to run the ECC `multi-frontend` workflow in Codex.
