# ECC Command Prompt: /cpp-build

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/cpp-build.md

Use this prompt to run the ECC `cpp-build` workflow in Codex.
