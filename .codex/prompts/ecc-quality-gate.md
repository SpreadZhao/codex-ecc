# ECC Command Prompt: /quality-gate

Source: /nix/store/7bmy0z0ymx3hgjbhiiixxi0f43djs56c-source/commands/quality-gate.md

Use this prompt to run the ECC `quality-gate` workflow in Codex.
